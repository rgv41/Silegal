...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/logo_silegal_1_no.png" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">Admin Silegal</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('pt-biasa') ? 'active' : '') }}" href="{{ url('pt-biasa') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-building text-dark" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Form PT Biasa</span>
        </a>
      </li>

      <!-- Form PT Perorangan -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('pt-perorangan') ? 'active' : '') }}" href="{{ url('pt-perorangan') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-user text-dark" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Form PT Perorangan</span>
        </a>
      </li>

      <!-- Form Firma -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('firma') ? 'active' : '') }}" href="{{ url('firma') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-handshake text-dark" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Form Firma</span>
        </a>
      </li>

      <!-- Form Yayasan -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('yayasan') ? 'active' : '') }}" href="{{ url('yayasan') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-users text-dark" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Form Yayasan</span>
        </a>
      </li>
      <!-- Form CV -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('cv') ? 'active' : '') }}" href="{{ url('cv') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-file-alt text-dark" aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Form CV</span>
        </a>
      </li>

      <!-- Form KBLI -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('kbli') ? 'active' : '') }}" href="{{ url('kbli') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-list text-dark" aria-hidden="true"></i>
          </div>
